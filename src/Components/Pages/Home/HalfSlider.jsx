...
const HalfSlider = () => {
  return (
            ...
            <Helmet>
		<title>Home Half Slider</title>
		<meta name="decription" content="This is from Home Half Slider"></meta>
	</Helmet>
				...
				<div className="overlay_slider">
					<div className="swiper-container">
						<div className="swiper-wrapper">
							<div className="swiper-slide"><div className="main_image" data-bg-img="img/drops/1.jpg"></div></div>
							<div className="swiper-slide"><div className="main_image" data-bg-img="img/drops/2.jpg"></div></div>
							<div className="swiper-slide"><div className="main_image" data-bg-img="img/drops/3.jpg"></div></div>
							<div className="swiper-slide"><div className="main_image" data-bg-img="img/drops/4.jpg"></div></div>
							<div className="swiper-slide"><div className="main_image" data-bg-img="img/drops/5.jpg"></div></div>
						</div>
					</div>
				</div>
